(function(g){var window=this;'use strict';var ukb=function(a,b){g.X.call(this,{G:"button",Na:["ytp-miniplayer-expand-watch-page-button","ytp-button","ytp-miniplayer-button-top-left"],Y:{title:"{{title}}","data-tooltip-target-id":"ytp-miniplayer-expand-watch-page-button","aria-keyshortcuts":"i","data-title-no-tooltip":"{{data-title-no-tooltip}}"},X:[{G:"svg",Y:{height:"24px",version:"1.1",viewBox:"0 0 24 24",width:"24px"},X:[{G:"g",Y:{fill:"none","fill-rule":"evenodd",stroke:"none","stroke-width":"1"},X:[{G:"g",Y:{transform:"translate(12.000000, 12.000000) scale(-1, 1) translate(-12.000000, -12.000000) "},
X:[{G:"path",Y:{d:"M19,19 L5,19 L5,5 L12,5 L12,3 L5,3 C3.89,3 3,3.9 3,5 L3,19 C3,20.1 3.89,21 5,21 L19,21 C20.1,21 21,20.1 21,19 L21,12 L19,12 L19,19 Z M14,3 L14,5 L17.59,5 L7.76,14.83 L9.17,16.24 L19,6.41 L19,10 L21,10 L21,3 L14,3 Z",fill:"#fff","fill-rule":"nonzero"}}]}]}]}]});this.I=a;this.Ta("click",this.onClick,this);this.updateValue("title",g.qT(a,"Expand","i"));this.update({"data-title-no-tooltip":"Expand"});g.tb(this,g.kT(b.Hc(),this.element))},vkb=function(a){g.X.call(this,{G:"div",
S:"ytp-miniplayer-ui"});this.yg=!1;this.player=a;this.T(a,"minimized",this.Bh);this.T(a,"onStateChange",this.MQ)},wkb=function(a){g.WT.call(this,a);
this.u=new g.PK(this);this.j=new vkb(this.player);this.j.hide();g.XS(this.player,this.j.element,4);a.Ag()&&(this.load(),g.Wq(a.getRootNode(),"ytp-player-minimized",!0))};
g.x(ukb,g.X);ukb.prototype.onClick=function(){this.I.Qa("onExpandMiniplayer")};g.x(vkb,g.X);g.k=vkb.prototype;
...
a=new ukb(this.player,this);g.H(this,a);a.Ja(this.Ak.element);this.xv=new g.X({G:"div",S:"ytp-miniplayer-controls"});g.H(this,this.xv);this.xv.Ja(this.Ak.element);this.T(this.xv.element,"click",this.qI);var b=new g.X({G:"div",S:"ytp-miniplayer-button-container"});g.H(this,b);b.Ja(this.xv.element);a=new g.X({G:"div",S:"ytp-miniplayer-play-button-container"});g.H(this,a);a.Ja(this.xv.element);var c=new g.X({G:"div",S:"ytp-miniplayer-button-container"});g.H(this,c);c.Ja(this.xv.element);this.tY=new g.JV(this.player,
...
g.k.vy=function(){};
g.k.Qs=function(){};
g.k.zE=function(){};g.x(wkb,g.WT);g.k=wkb.prototype;g.k.onVideoDataChange=function(){if(this.player.getVideoData()){var a=this.player.getVideoAspectRatio(),b=16/9;a=a>b+.1||a<b-.1;g.Wq(this.player.getRootNode(),"ytp-rounded-miniplayer-not-regular-wide-video",a)}};
...
g.k.unload=function(){this.player.showControls();this.j.hide()};g.VT("miniplayer",wkb);})(_yt_player);
